...
public class SMWGrabber : SMWInteractor {
	...
	protected SMWGrabbable m_grabbedObj = null;
	Vector3 m_grabbedObjectPosOff;
	Quaternion m_grabbedObjectRotOff;
	protected Dictionary<SMWGrabbable, int> m_grabCandidates = new Dictionary<SMWGrabbable, int>();

	/// <summary>
	/// The currently grabbed object.
	/// </summary>
	public SMWGrabbable grabbedObject
	{
		get { return m_grabbedObj; }
	}

	public void ForceRelease(SMWGrabbable grabbable)
	{
		bool canRelease = (
			(m_grabbedObj != null) &&
	...
	void OnTriggerEnter(Collider otherCollider)
	{
		...
		SMWGrabbable grabbable = otherCollider.GetComponent<SMWGrabbable>() ?? otherCollider.GetComponentInParent<SMWGrabbable>();
	...
	protected void GrabBegin()
	{
		...
		SMWGrabbable closestGrabbable = null;
		Collider closestGrabbableCollider = null;

		// Iterate grab candidates and find the closest grabbable candidate
		foreach (SMWGrabbable grabbable in m_grabCandidates.Keys)
		{
	...
	protected void GrabEnd()
	{
		if (m_grabbedObj != null)
		{
			...
			OVRPose localVelocity = new OVRPose() { position = OVRInput.GetLocalControllerVelocity(m_controller), orientation = Quaternion.Euler( OVRInput.GetLocalControllerAngularVelocity(m_controller) ) };
	...
	protected void OffhandGrabbed(SMWGrabbable grabbable)
	{
