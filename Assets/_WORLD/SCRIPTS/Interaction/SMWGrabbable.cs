...
public class SMWGrabbable : SMWInteractable {
	...
	protected SMWGrabber m_grabbedBy = null;
	...
	/// <summary>
	/// An offset relative to the SMWGrabber where this object can snap when grabbed.
	/// </summary>
	...
	/// <summary>
	/// Returns the SMWGrabber currently grabbing this object.
	/// </summary>
	public SMWGrabber grabbedBy
	{
	...
	/// </summary>
	virtual public void GrabBegin(SMWGrabber hand, Collider grabPoint)
	{
		m_grabbedBy = hand;
